...
local function get_cpptools_debugger()
  ...
  if ok_registry and mason_registry.has_package and mason_registry.has_package("cpptools") then
    ...
    if cpptools and cpptools.is_installed and cpptools:is_installed() and cpptools.get_install_path then
      return cpptools:get_install_path() .. "/extension/debugAdapters/bin/OpenDebugAD7"
    end
  end
